  ...
  return (
    <div className="inline-flex flex-col items-center">
      <button
        ...
        aria-label={label}
        className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-all focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1
      ...
      >
        {isListening ? (
          ...
          // 마이크 아이콘 (SVG)
          <svg aria-hidden className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
