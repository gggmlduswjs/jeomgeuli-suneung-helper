    ...
    try {
      ...
      try {
        ...
        try {
          ...
          await progressAPI.save({
            user_id: 'u_demo',
            book_id: progress.book_id || undefined,
            lesson_id: progress.lesson_id || undefined,
            unit_id: unit.unit_id,
            syncpoint_id: progress.syncpoint_id || undefined,
          });
        ...
        <div className="w-full max-w-md space-y-4">
          ...
          <div className="pt-4">
            <button
              ...
              className="w-full p-4 border border-border/50 rounded-2xl
                         shadow-soft hover:shadow-soft-lg hover:border-primary/30
              ...
              aria-label="관리자 페이지"
            >
              <div className="text-sm font-semibold mb-1 text-fg">⚙️ 관리자 페이지</div>
              <p className="text-xs text-muted">교재 관리, 업로드, 파싱 상태 모니터링</p>
            </button>
          </div>
